...
const char* ssid = "Windoge";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "Thang2@@12@@1";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "nhathongminhcuong.herokuapp.com";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
